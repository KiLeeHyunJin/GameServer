    ...
    internal class Program
    {
        ...
        public static Tuple<string, string, string> ParseMembers(XmlReader r)
        {
            ...
            while (r.Read())
            {
                ...
                Console.WriteLine($"TypeName {r.Name} MemberName : {memberName}");
                ...
                switch (memberType)
                {
                    ...
                    case "double":
                        memberCode += string.Format(PacketFormat.memberFormat, memberType, memberName);
                        readCode += string.Format(PacketFormat.readFormat, memberName, ToMeberType(memberType), memberType);
        ...
        public static string ToMeberType(string memberType)
        {
            switch (memberType)
            {
                case "bool":
